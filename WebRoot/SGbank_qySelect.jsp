			...
			<input type="hidden" name="dse_sessionId" value="<%=dse_sessionId%>"/>
				<div class="content_box" align="left">
					<!-- <div class="tent">
						 ...
						 <dl>
						     <dt><a href="/personbank/HttpProxy?URL=/midserv/dsfbank_qyzc.jsp&dse_sessionId=<!--%=dse_sessionId%>&buscla=01&CLI_IDENTITY_CARD=<!--%=CLI_IDENTITY_CARD%>">税务</a></dt>
						 </dl>	   
					</div>
					<div class="tent">
						 ...
						 <dl>
						     <dt><a href="/personbank/HttpProxy?URL=/midserv/dsfbank_qyzc.jsp&dse_sessionId=<!--%=dse_sessionId%>&buscla=02&CLI_IDENTITY_CARD=<!--%=CLI_IDENTITY_CARD%>">社保</a></dt>
						 </dl>	   
					</div>
	    			<div class="tent">
						 ...
						 <dl>
						     <dt><a href="/personbank/HttpProxy?URL=/midserv/dsfbank_qyzc.jsp&dse_sessionId=<!--%=dse_sessionId%>&buscla=03&CLI_IDENTITY_CARD=<!--%=CLI_IDENTITY_CARD%>" >居民养老保险</a></dt>
						 </dl>	   
					</div>		-->		
			      	<div class="tent">
						 ...
						 <dl>
						     <dt><a  href="/personbank/HttpProxy?URL=/midserv/dsfbank_qyzc.jsp&dse_sessionId=<%=dse_sessionId%>&buscla=04&CLI_IDENTITY_CARD=<%=CLI_IDENTITY_CARD%>">通讯</a></dt>
						 </dl>	   
					</div>
					<div class="tent">
						 ...
						 <dl>
						     <dt><a   href="/personbank/HttpProxy?URL=/midserv/dsfbank_qyzc.jsp&dse_sessionId=<%=dse_sessionId%>&buscla=05&CLI_IDENTITY_CARD=<%=CLI_IDENTITY_CARD%>">水费</a></dt>
						 </dl>	   
					</div>
					<div class="tent">
						 ...
						 <dl>
						     <dt><a href="/personbank/HttpProxy?URL=/midserv/dsfbank_qyzc.jsp&dse_sessionId=<%=dse_sessionId%>&buscla=06&CLI_IDENTITY_CARD=<%=CLI_IDENTITY_CARD%>">电费</a></dt>
						 </dl>	   
					</div>
					<div class="tent">
						 ...
						 <dl>
						     <dt><a href="/personbank/HttpProxy?URL=/midserv/dsfbank_qyzc.jsp&dse_sessionId=<%=dse_sessionId%>&buscla=07&CLI_IDENTITY_CARD=<%=CLI_IDENTITY_CARD%>">燃气费</a></dt>
						 </dl>	   
					</div>				
					<!-- <div class="tent">
						 ...
						 <dl>
						     <dt><a href="/personbank/HttpProxy?URL=/midserv/dsfbank_qyzc.jsp&dse_sessionId=<!--%=dse_sessionId%>&buscla=08&CLI_IDENTITY_CARD=<!--%=CLI_IDENTITY_CARD%>">电视</a></dt>
						 </dl>	   
					</div> -->						
					<div class="tent">
						 ...
						 <dl>
						     <dt><a href="/personbank/HttpProxy?URL=/midserv/dsfbank_qyzc.jsp&dse_sessionId=<%=dse_sessionId%>&buscla=09&CLI_IDENTITY_CARD=<%=CLI_IDENTITY_CARD%>">物业</a></dt>
						 </dl>	   
					</div>	
		</div>
</form>
