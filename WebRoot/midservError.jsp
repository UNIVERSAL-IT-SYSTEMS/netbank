...
<html>
	...
	<head>
		...
		<link href="/personbank/css/csspt.css" rel="stylesheet"	type="text/css">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0"	align="center">
							<tr>
								<td width="7%" align="right">
									<img src="/personbank/images/jiaoyi-fail.gif" width="42"	height="40" hspace="4">
								</td>
						...
						<table width="100%" align="center" cellpadding="1" cellspacing="1" class="tab">
							...
							<tr>
								<td class="tab_result" align="center" colspan="2">
									<p align="center">
										<input type="button" onclick="tj();" value="确定"	class="button_bg">
									</p>
								</td>
							</tr>
						</table>
