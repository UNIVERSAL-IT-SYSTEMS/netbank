...
<script language="JavaScript" src="/personbank/HttpProxy?URL=/midserv/js/public_card.js&dse_sessionId=<%=dse_sessionId%>"></script>
 <script language="javascript" type="text/javascript">
  ...
  function select_change(area)
  {
     ...
     if(areanum!="null"&&areanum!=""&&areanum!=null){
          createXMLHttpRequest();
           var url="/personbank/HttpProxy?URL=/midserv/deal.jsp&dse_sessionId=<%=dse_sessionId%>&areanum="+areanum+"&buscla="+buscla+"&JYFLG=2";
   ...
   function select_change_qy(qy)
  {
     ...
     var areanum;
     var buscla = "<%=BUSCLA %>";
    	 areanum=document.form1["areanum"].value;
      
     if(areanum!="null"&&qye!="null"&&areanum!=""&&qye!=""&&areanum!=null&&qye!=null){
          createXMLHttpRequest();
           var url="/personbank/HttpProxy?URL=/midserv/deal.jsp&dse_sessionId=<%=dse_sessionId%>&areanum="+areanum+"&buscla="+buscla+"&qy="+qye+"&JYFLG=2";
          xmlHttp.open("GET",url,true);
          xmlHttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
  ...
  function condition_tcusid(){
           		...
           		if(document.form9["areanum"].value=="null"||document.form9["areanum"].value==""){
           		
           			alert("请选择地区");
           			return false;
           		}
           		if(document.form9["qy"].value=="null"||document.form9["qy"].value==""){
           		
           			alert("请选择收费企业");
           			return false;	
           		}
           		if(document.form9["FUNFLG"].value=="null"||document.form9["FUNFLG"].value==""){
...
<form action="/personbank/HttpProxy" method=post name="form1" onsubmit="return condition_tcusid();">
	    ...
	    <table cellpadding="1" cellspacing="1" class="tab" width="100%" >
				...
				<tr>
							...
							<td width="60%" align="left"  class="tab_tr">
								<input type="text" name="FUNFLG" value="" >
